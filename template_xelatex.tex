\documentclass[utf8, a4paper, 10.5pt]{book}
...
\usepackage{graphicx}
\usepackage[labelsep=space]{caption} %五号，宋体/Time new roman
...
\setcounter{page}{1}
\pagenumbering{Roman}
\songti\fontsize{12pt}{18pt} %小四号，宋体/Time new roman，1.5倍行距
...
\fontsize{10.5pt}{15.75pt} %5号，Time new roman，1.5倍行距
\bigskip
\noindent
{\bfseries Key Words: }
...
\chapter*{参考文献}
\begin{enumerate}[{[1]}]
\songti\fontsize{10.5pt}{10.5pt} %正文，五号，中文宋体，英文Time new roman，1倍行距
	\item 期刊
	\item 网络文档
\end{enumerate}
...
\songti\fontsize{12pt}{12pt} %小四号，中文宋体，英文Time new roman，1倍行距
...
\chapter*{致谢}
\songti\fontsize{12pt}{18pt} %正文，小四号，中文宋体，英文Time new roman，1.5倍行距
